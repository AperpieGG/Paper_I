...
plt.plot(temperature, fit_total, 'b-', label='Marana sCMOS')
plt.plot(temperature, fit_1, color='orange', linestyle='--')
plt.plot(temperature, fit_2, 'y--')
plt.scatter(temperature, dc, color='blue')
plt.plot(temperature_ccd, dc_ccd, 'r--', label='iDus 416 CCD')
plt.yscale('log')
